...
frappe.ready(function () {
	...
	if (_navbar) {
		new MutationObserver(function () {
			document
				.querySelectorAll(".navbar-home img, .navbar .app-logo")
...
function _zupra_inject_home() {
	var section = document.querySelector(".desk-sidebar .standard-sidebar-section, .desk-sidebar");
	if (!section) return;
...
function _zupra_sync_sidebar() {
	...
	frappe.router.on("change", function () {
		...
		document
			.querySelectorAll(".desk-sidebar .standard-sidebar-item, .desk-sidebar .sidebar-item")
			.forEach(function (el) {
